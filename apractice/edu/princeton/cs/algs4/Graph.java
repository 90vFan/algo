 ...
 * It also provides methods for returning the degree of a vertex, the number of
 * vertices <em>V</em> in the graph, and the number of edges <em>E</em> in the
 * graph. Parallel edges and self-loops are permitted. By convention, a
 * self-loop <em>v</em>-<em>v</em> appears in the adjacency list of <em>v</em>
 * twice and contributes two to the degree of <em>v</em>.
 * <p>
 ...
 * iterating over the vertices returned by {@link #adj(int)} takes time
 * proportional to the degree of the vertex.) Constructing an empty graph with
 * <em>V</em> vertices takes &Theta;(<em>V</em>) time; constructing a graph with
 * <em>E</em> edges and <em>V</em> vertices takes &Theta;(<em>E</em> +
 * <em>V</em>) time.
 * <p>
